...
<body>
                    ...
                    <nav class="classy-navbar justify-content-between" id="palatinNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                ...
                                <!-- Button -->
                                <div class="menu-btn">
                                    <a href="{{ url('/booking') }}" class="btn palatin-btn">Make a Reservation</a>
                                </div>
    ...
    <section class="breadcumb-area bg-img d-flex align-items-center justify-content-center" style="background-image: url('{{ asset('royal-master/img/bg-img/bg-9.jpg') }}');">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="footer-widget-area mt-50">
                        ...
                        <img src="{{ asset('royal-master/img/bg-img/footer-map.png') }}" alt="">
                    </div>
                </div>
