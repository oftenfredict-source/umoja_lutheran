    ...
    <div class="receipt-container">
        ...
        <div class="receipt-info">
            <div class="info-block">
                ...
                <p><strong>Time:</strong>
                    ...
                    @endif
                    @if($dayService->is_all_day)
                        <span style="color: #940000; font-weight: bold;">(All Day: Day & Night)</span>
                    @endif
                </p>
                ...
                @elseif($serviceTypeKey === 'conference_room')
                    ...
                    <p><strong>Duration:</strong> {{ $dayService->duration }}</p>
                    <p><strong>Purpose:</strong> {{ $dayService->purpose }}</p>
                @endif
            </div>
            <div class="info-block">
                <h3>Guest Information</h3>
                <p><strong>Name:</strong> {{ $dayService->guest_name }}</p>
                @if($dayService->organization)
                    <p><strong>Org/Dept:</strong> {{ $dayService->organization }}</p>
                @endif
                ...
                @endif
                <p><strong>{{ $serviceTypeKey === 'parking' ? 'Number of Vehicles' : 'Number of People' }}:</strong>
                    {{ $dayService->number_of_people }}</p>
            </div>
        </div>
        ...
        <table class="details-table">
            ...
            <tbody>
                ...
                @else
                    ...
                    <tr>
                        <td>
                            {{ $dayService->service_type_name }} Service
                            @if($dayService->is_all_day)
                                <br><small style="color: #940000; font-weight: bold;">(Day & Night Rate Applied)</small>
                            @endif
                        </td>
                        <td style="text-align: right;">
                            @if($dayService->guest_type === 'tanzanian')
        ...
        @if($barConsumption->isNotEmpty())
            <table class="details-table">
                <thead>
                    <tr>
                        <th colspan="4" style="background-color: #940000; color: white; text-align: center;">Bar &
                            Restaurant Consumption</th>
                    </tr>
                    <tr>
                        <th>Item</th>
                        <th>Qty</th>
