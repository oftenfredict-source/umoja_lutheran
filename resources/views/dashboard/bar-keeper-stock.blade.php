...
@section('content')
    <div class="app-title">
        <div>
            ...
            <p>Monitor your counter inventory and sales performance</p>
        </div>
    ...
    <div class="row mb-4">
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm"
                style="border-radius: 12px; background: linear-gradient(135deg, #940000 0%, #d40000 100%);">
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm"
                style="border-radius: 12px; background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%);">
                <div class="card-body p-3 text-white">
                    <div class="d-flex align-items-center">
                        <div class="rounded-circle mr-3 d-flex align-items-center justify-content-center"
                            style="width: 50px; height: 50px; background: rgba(255,255,255,0.2);">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 font-weight-bold">{{ number_format($myStock->sum('current_stock_pics'), 0) }}
                            </h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="card border-0 shadow-sm"
                style="border-radius: 12px; background: linear-gradient(135deg, #f7971e 0%, #ffd200 100%);">
                <div class="card-body p-3 text-white">
                    <div class="d-flex align-items-center">
                        <div class="rounded-circle mr-3 d-flex align-items-center justify-content-center"
                            style="width: 50px; height: 50px; background: rgba(255,255,255,0.2);">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 font-weight-bold">{{ number_format($myStock->sum('revenue_generated'), 0) }}
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="tile-body">
                        ...
                        <div class="col-md-6 text-right d-flex align-items-end justify-content-end">
                            <div id="searchResults" class="text-muted pr-3 pb-2">
                                Showing <span id="resultCount"
                                    class="font-weight-bold mx-1 text-dark">{{ $myStock->count() }}</span> products
                            </div>
                    ...
                    @else
                        ...
                        <ul class="nav nav-pills nav-fill mb-3" role="tablist"
                            style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 10px; border-radius: 10px;">
                            <li class="nav-item">
                                <a class="nav-link active" id="all-tab" data-toggle="tab" href="#all" role="tab"
                                    style="border-radius: 8px; font-weight: 600; color: white;">
                            ...
                            @foreach($categories as $category => $items)
                                <li class="nav-item">
                                    <a class="nav-link" id="{{ $category }}-tab" data-toggle="tab" href="#{{ $category }}"
                                        role="tab" style="border-radius: 8px; font-weight: 600; color: rgba(255,255,255,0.8);">
                                        <i class="fa {{ $categoryIcons[$category] ?? 'fa-tag' }}"></i>
                                        {{ $items->first()['category_name'] ?? ucfirst(str_replace('_', ' ', $category)) }}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                                ...
                                <div class="form-group mb-0 mt-2">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" class="form-control" id="minimum_stock"
                                            name="minimum_stock" required min="0">
                    ...
                    <div class="p-3 rounded" style="background: #fff3e0; border-left: 5px solid #e77a31;">
                        <h6 class="font-weight-bold text-warning" style="color: #cc6a27 !important;"><i
                                class="fa fa-money-bill-wave"></i> Active Pricing (Daily Charges)</h6>
                            ...
                            <div class="form-row mt-2">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control border-warning" id="price_pic"
                                            name="selling_price_per_pic" required min="0">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label class="small font-weight-bold">Glass/Tot Price (TSH)</label>
                                        <input type="number" class="form-control border-warning" id="price_glass"
                                            name="selling_price_per_serving" min="0">
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-block text-white" style="background: #e77a31;">Update All
                                Prices</button>
                        </form>
                    </div>
                </div>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        #bulkActionBar {
            ...
            padding: 10px 15px;
            bottom: 60px;
            /* Above bottom nav if exists, or just spaced */
            border-radius: 15px;
...
<div id="bulkActionBar" class="animated fadeInUp">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center w-100 justify-content-center">
            ...
            <button class="btn btn-sm btn-outline-danger mr-2" id="clearSelectionBtn"
                style="color: #ff9d9d; border-color: #ff9d9d;"><i class="fa fa-times"></i> Clear</button>
            <button class="btn btn-sm btn-warning font-weight-bold flex-grow-1" id="bulkRequestBtn"
